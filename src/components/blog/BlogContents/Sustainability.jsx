  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-4 text-green-800">
        🌿 Farming & Sustainability: How Ceylon Spices Support the Earth and Farmers
      </h1>

      <h3 className="text-lg font-semibold mb-2 text-gray-900">🌱 Introduction: A Greener Way to Grow</h3>
      ...
      <p className="mb-4 text-gray-800">
        ...
        It's about balance—between nature and agriculture, between economy and ecology.
      </p>
      <img 
        src={sus1} 
      ...
      <h3 className="text-lg font-semibold mb-2 text-gray-900">🌳 2. Agroforestry: Spices Grown Under the Forest Canopy</h3>
      <p className="mb-4 text-gray-800">
        Sri Lankan spice farms often operate as <strong>agroforests</strong>—a system where spices grow alongside coconut, jackfruit, betel, and banana trees. 
      ...
      <h3 className="text-lg font-semibold mb-2 text-gray-900">🧑‍🌾 3. Empowering Smallholder Farmers</h3>
      <p className="mb-4 text-gray-800">
      ...
      <h3 className="text-lg font-semibold mb-2 text-gray-900">♻️ 5. A Global Shift Toward Sustainable Spices</h3>
      <p className="mb-4 text-gray-800">
      ...
      <p className="mb-4 text-gray-800">
        Ceylon spice farming offers more than a burst of flavor—it offers <strong>hope for a sustainable future</strong>. 
