    ...
    return (
      <div className="text-center py-16">
        <div className="max-w-md mx-auto">
          ...
          <p className="text-gray-600 text-lg mb-2">The marketplace is currently empty.</p>
          <p className="text-gray-500 mb-8">Be the first to list your agricultural products!</p>
          
          <div className="space-y-4">
            <button
              onClick={() => window.location.href = '/seller-dashboard/add-product'}
