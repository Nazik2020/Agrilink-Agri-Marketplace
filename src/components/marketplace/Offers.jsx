    ...
    const fetchProducts = async () => {
      try {
        ...
        if (response.data.success) {
          console.log("Offers component: Products found:", response.data.products.length);
          console.log("Offers component: Products data:", response.data.products);
          setProducts(response.data.products);
        } else {
          console.log("Offers component: API returned error:", response.data.message);
          ...
          >
            ...
            <div className="flex flex-col flex-1 px-4 pt-3 pb-4">
              <div className="flex items-center justify-between mb-1">
                <span className="text-green-600 font-semibold text-sm">{product.category || "Offers"}</span>
