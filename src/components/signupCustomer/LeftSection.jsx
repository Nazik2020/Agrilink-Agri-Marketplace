...
const LeftSection = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      description:
        "lace your order, sit back, relax. Every transaction is protected, every step is confirmed — from checkout to doorstep. Shopping that feels as trustworthy as your local grocer.",
    },
    {
